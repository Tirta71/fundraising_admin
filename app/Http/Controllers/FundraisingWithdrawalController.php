...
use App\Http\Requests\UpdateFundraisingWithdrawalsRequest;
...
class FundraisingWithdrawalController extends Controller
{
     ...
     */
    public function update(UpdateFundraisingWithdrawalsRequest $request, FundraisingWithdrawal $fundraisingWithdrawal)
    {
        $validated = $request->validated();
        ...
        return redirect()->route('adminfundraising_withdrawals.show', $fundraisingWithdrawal);
    }
