<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <img id="fullImage" src="{{ Storage::url($fundraisingWithdrawal->proof) }}" alt="" class="rounded-2xl object-cover w-[300px] h-[200px] mb-3 cursor-pointer">

                @else
                <hr class="my-5">
                <form action="{{ route('adminfundraising_withdrawals.update', $fundraisingWithdrawal) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
    ...
    <script>
        document.getElementById('fullImage').addEventListener('click', function() {
            ...
            fullImage.style.bottom = '0';
            fullImage.style.right = '0';
            fullImage.style.margin = 'auto';
            fullImage.style.zIndex = '9999';
            ...
            overlay.addEventListener('click', function() {
                ...
                this.parentNode.removeChild(fullImage);
