        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="flex flex-row justify-between">
                    ...
                    @role('owner')
                    <form action="{{ route('adminfundraising_withdrawals.activate_fundraising', $fundraising) }}" method="POST">
                        @csrf
                ...
                <div class="item-card flex flex-row gap-y-10 justify-between items-center">
                    ...
                    <div class="flex flex-row items-center gap-x-3">
                        <a href="{{ route('adminfundraisings.edit', $fundraising) }}" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                            Edit
                        </a>
                        <form action="{{ route('adminfundraisings.destroy', $fundraising) }}" method="POST">
                            @csrf
                            @method('DELETE')
                ...
                <form method="POST" action="{{ route('adminfundraising_withdrawals.store', $fundraising) }}" enctype="multipart/form-data">
                    @csrf
