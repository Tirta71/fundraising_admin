<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-row justify-between items-center">
            ...
            <a href="{{ route('admincategories.create') }}" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                Add New
            </a>
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row justify-between items-center">
                    ...
                    <div class="hidden md:flex flex-row items-center gap-x-3">
                        <a href="{{ route('admincategories.edit', $category) }}" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                            Edit
                        </a>
                ...
                @empty
                    <p>
                        Belum ada data baru silahkan ditambahkan
                    </p>
                @endforelse
            </div>
        </div>
